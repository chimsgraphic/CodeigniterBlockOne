...
<div class="row">
        ...
        <h2 class="page-header">Inner Or Simple Join With Condition</h2>
        <p class="alert alert-info"><small>Returns the combined resultset that met the conditional filter provided by the 'Where' clause</small></p>
